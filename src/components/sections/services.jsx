  ...
  return (
    <div className="section-cards">
      <Card
        title={"Social Media"}
        description={
          "Desenvolvimento estratégico e gestão completa de conteúdo para Instagram e Facebook. Impulsione o engajamento e alcance do seu público com posts criativos, planejados e alinhados com a identidade da sua marca."
        }
        image={social}
      />
      ...
      <Card
        title={"Landing Page"}
        description={"Desenvolvemos landing pages de alta conversão, projetadas para captar leads e transformar visitantes em clientes. Cada detalhe é pensado para entregar resultados."}
        image={landing}
      />

      <Card
        title={"WebSite"}
        description={"Sites modernos, responsivos e otimizados para SEO. Garantimos que sua presença online seja profissional e atraente, proporcionando a melhor experiência ao usuário."}
        image={web}
      />
